    ...
    return(
        <>
                ...
                <div className="w-[100%] p-[24px] pb-[32] flex flex-col items-center bg-[#161D2F] rounded-[10px] md:rounded-[20px] "  >
                    <h1 className="text-[32px] text-[#FFF] font-light tracking-[-0.5px] mb-[40px] self-start	" >Login</h1>
                    ...
                    <p className={`${userError?"text-[13px] text-[#FC4747] font-light":"hidden"} mb-[40px]  `} onClick={()=>{HandleLogin()}} >Email or password is not correct</p>
                    <button className="w-[100%] bg-[#fab907] rounded-[6px] py-[15px] text-[15px] text-[#FFF] font-light mb-[24px] hover:bg-[#FFF] hover:text-[#161D2F] " onClick={() =>  logNavigation("/home")} >Login to your account</button>
                    <span className=" flex" ><a className="w-[156px] text-[15px] text-[#FFF] font-light mr-[9px]" >Don’t have an account?</a><Link className="text-[15px] text-[#fab907] font-light " to="/signup" >Sign Up</Link></span>
                </div>
