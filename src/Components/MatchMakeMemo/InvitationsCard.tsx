...
const InvitationsCard = React.memo(({i,length,item,acceptMatchMake,declineMatchMake}:{i:number,length:number,item:Invitation,acceptMatchMake:(username: string)=>void,declineMatchMake:(username: string)=>void}) =>{
  return (
<div
