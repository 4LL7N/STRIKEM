          ...
          <div className="flex gap-[2px] items-center" >
            {userSettingsBox.settingsPage != "settings"?
                <>
                  ...
                  <h1 className="text-[20px] text-white leading-6 ">{userSettingsBox.settingsPage == "Profile from Profile"?"change profile":userSettingsBox.settingsPage}</h1> 
                </> 
              :
                <h1 className="text-[32px] text-white">User settings</h1>  
            }
          </div>
          <IoMdClose
            style={{
